# AI Scrum Master — Documentation Index
...
Regenerate the Word file from Markdown: `node scripts/md-to-docx.mjs docs/END_USER_GUIDE.md docs/AI_Scrum_Master_End_User_Guide.docx`
